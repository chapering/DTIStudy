...
NORMALCASEDATADIR=${DATADIR}/normal_blk_whole
...
function task5()
{
	...
	do
		...
		do
			...
			${NORMALCASEDATADIR}/region_for_task5/s${n}/${CURFB}/skeleton_region_s${n}.data \
			-i \
			${NORMALCASEDATADIR}/region_for_task5/s${n}/${CURFB}/${RESID}/no/fiberidx_*_region_s${n}.data \
			-p ${TASKPROGIDFILE} \
			-t ${BINDIR}/task5/tasktext 
...
function task7()
{
	...
	do
		...
		do
			...
			-j \
			${NORMALCASEDATADIR}/region_for_task7/s${n}/${CURFB}/${RESID}/tumorbox_0_region_s${n}.data \
			-p ${TASKPROGIDFILE} \
