...
{
	let "TASKNO += 1"
	echo -e "\n\n overall progress : $TASKNO / 6" > ${TASKPROGIDFILE}
}
...
function pretask()
{
	...
	${BINDIR}/pretask/singleitr \
		-f ${NORMALCASEDATADIR}/region_for_task1/s2/cc/region_s2.data \
...
function task3()
{
	...
	do
		...
		-s \
		${NORMALCASEDATADIR}/region_for_task3/s${n1}/${CURFB}/skeleton_region_s${n1}.data \
		-i \
		...
		-s \
		${NORMALCASEDATADIR}/region_for_task3/s${n2}/${CURFB}/skeleton_region_s${n2}.data \
		-i \
...
function task4()
{
	...
	do
		...
		-j \
		${NORMALCASEDATADIR}/region_for_task4/s${n}/${CURFB}/pos2/tumorbox_0_region_s${n}.data \
...
function task5()
{
	...
	do
		...
		-s \
		${NORMALCASEDATADIR}/region_for_task5/s${n1}/${CURFB}/skeleton_region_s${n1}.data \
		-i \
		...
		-s \
		${NORMALCASEDATADIR}/region_for_task5/s${n2}/${CURFB}/skeleton_region_s${n2}.data \
		-i \
