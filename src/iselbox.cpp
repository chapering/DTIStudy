...
GLdouble CIselbox::getClickDist(int x, int y) const
{
	GLint viewport[4];
	GLdouble mvmat[16], prjmat[16];
	...
	return point_t((GLdouble)x, (GLdouble)y, 0.0).distanceTo(
				point_t(ct2d.x, ct2d.y, 0.0) );
