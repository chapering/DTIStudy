	...
	do
		...
		do
			...
			do
				...
				while migrating
				'
				for fidxfile in `ls ${srcreg}/s${i}/${fb}/${ans}/fiberidx*_region_s${i}.data`
				do
					head -n1 ${srcreg}/s${i}/${fb}/${ans}/${fidxfile##*/} \
					1> ${dstreg}/s${i}/${fb}/${ans}/${fidxfile##*/}

					${FIBERIDX_MIGRATOR} \
					${srcreg}/s${i}/${fb}/${ans}/${fidxfile##*/} \
					${srcreg}/s${i}/${fb}/region_s${i}.data \
					${dstreg}/s${i}/${fb}/region_s${i}.data \
					1 \
					1>> ${dstreg}/s${i}/${fb}/${ans}/${fidxfile##*/} 
					echo -e -n "\t ${srcreg}/s${i}/${fb}/${ans}/${fidxfile##*/} ---> "
					echo -e "\t ${dstreg}/s${i}/${fb}/${ans}/${fidxfile##*/}"
				done
			done
			...
			do
				...
				do
					...
					while migrating
					'
					for fidxfile in `ls ${srcreg}/s${i}/${fb}/${p}/${ans}/fiberidx*_region_s${i}.data`
					do
						head -n1 ${srcreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/} \
						1> ${dstreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/} 

						${FIBERIDX_MIGRATOR} \
						${srcreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/} \
						${srcreg}/s${i}/${fb}/region_s${i}.data \
						${dstreg}/s${i}/${fb}/${p}/region_s${i}.data \
						1 \
						1>> ${dstreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/} 
						echo -e -n "\t ${srcreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/} ---> "
						echo -e "\t ${dstreg}/s${i}/${fb}/${p}/${ans}/${fidxfile##*/}"
					done
				done
