...
{
	let "TASKNO += 1"
	echo -e "\n\n overall progress : $TASKNO / 70" > ${TASKPROGIDFILE}
}
...
function task1()
{
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos1"
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos2"
...
function task5()
{
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos1, belong to a bundle= $CURCHOICE"
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos2, belong to a bundle= $CURCHOICE"
...
function task6()
{
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos1, making= $CURCHOICE"
	...
	do
		...
		echo -e "\t\tResolution: $n; Data: bundle focus $CURFB, pos2, making= $CURCHOICE"
