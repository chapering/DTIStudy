...
function task1()
{
	...
	do
		...
		do
			...
			-j \
			${NORMALCASEDATADIR}/region_for_task1/s${n}/${CURFB}/pos${RESID}/tumorbox_0_region_s${n}.data \
			-j \
			${NORMALCASEDATADIR}/region_for_task1/s${n}/${CURFB}/pos${RESID}/tumorbox_1_region_s${n}.data \
...
function task2()
{
	...
	do
		...
		do
			...
			-i \
			${NORMALCASEDATADIR}/region_for_task2/s${n}/${CURFB}/pos${RESID}/fiberidx_*_region_s${n}.data \
			-j \
			${NORMALCASEDATADIR}/region_for_task2/s${n}/${CURFB}/pos${RESID}/tumorbox_0_region_s${n}.data \
			-j \
			${NORMALCASEDATADIR}/region_for_task2/s${n}/${CURFB}/pos${RESID}/tumorbox_1_region_s${n}.data \
			-j \
			${NORMALCASEDATADIR}/region_for_task2/s${n}/${CURFB}/pos${RESID}/tumorbox_2_region_s${n}.data \
...
function task3()
{
	...
	do
		...
		do
			...
			-i \
			${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/pos${RESID}/touch/tumorbox_0_region_s${n}.data \
			-u \
			${TUMORDATADIR}/potato.sm \
			-t ${BINDIR}/task3/tasktext 

			echo -e "\n#####    when the tumor is apart from all fibers    ####" 
			${BINDIR}/task3/singleitr \
			-f \
			${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/region_s${n}.data \
			-s \
			${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/skeleton_region_s${n}.data \
			-i \
			${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/pos${RESID}/nontouch/tumorbox_0_region_s${n}.data \
			-u \
			${TUMORDATADIR}/potato.sm \
			-t ${BINDIR}/task3/tasktext 
...
function task4()
{
	...
	do
		...
		do
			...
			-j \
			${NORMALCASEDATADIR}/region_for_task4/s${n}/${CURFB}/pos${RESID}/tumorbox_0_region_s${n}.data \
...
function task5()
{
	...
	do
		...
		do
			...
			-i \
			${NORMALCASEDATADIR}/region_for_task5/s${n}/${CURFB}/pos${RESID}/yes/fiberidx_*_region_s${n}.data \
			...
			${NORMALCASEDATADIR}/region_for_task5/s${n}/${CURFB}/skeleton_region_s${n}.data \
			-i \
			${NORMALCASEDATADIR}/region_for_task5/s${n}/${CURFB}/pos${RESID}/no/fiberidx_*_region_s${n}.data \
			-t ${BINDIR}/task5/tasktext 
	...
	do
		...
		do
			...
			do
				...
				-i \
				${NORMALCASEDATADIR}/region_for_task6/s${n}/${CURFB}/pos${RESID}/fiberidx_${CUT}_s${n}.data \
				-s \
