...
{
	let "TASKNO += 1"
	echo -e "\n\n overall progress : $TASKNO / 68" > ${TASKPROGIDFILE}
}
...
function task3()
{
	...
	do
		...
		${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/skeleton_region_s${n}.data \
		-i \
		${NORMALCASEDATADIR}/region_for_task3/s${n}/${CURFB}/pos1/${CURCHOICE}/tumorbox_0_region_s${n}.data \
		-u \
		${TUMORDATADIR}/potato.sm \
		-t ${BINDIR}/task3/tasktext \
		-p ${TASKPROGIDFILE} \
...
function task6()
{
	...
	do
		...
		do
			...
			${NORMALCASEDATADIR}/region_for_task6/s${n}/${CURFB}/region_s${n}.data \
			-i \
			${NORMALCASEDATADIR}/region_for_task6/s${n}/${CURFB}/pos1/fiberidx_${CUT}_s${n}.data \
			-s \
			${NORMALCASEDATADIR}/region_for_task6/s${n}/${CURFB}/skeleton_region_s${n}.data \
			-t ${BINDIR}/task6/tasktext \
			-p ${TASKPROGIDFILE} \
